...
Module : `/home/pamerys/jarvis/mcp/tools/n8n.py` (stdlib pure, aucun secret en dur).
...
python3 /home/pamerys/jarvis/mcp/tools/n8n.py list

# Détail d'un workflow (id vu dans `list`)
python3 /home/pamerys/jarvis/mcp/tools/n8n.py get <workflow_id>

# Déclencher un workflow par son chemin de webhook (payload optionnel)
python3 /home/pamerys/jarvis/mcp/tools/n8n.py trigger mon-webhook --payload '{"cle":"valeur"}'
```
...
```jsonc
{
  "mcpServers": {
    "n8n-jarvis": {
      "command": "python3",
      "args": ["/home/pamerys/jarvis/mcp/n8n_mcp.py"],
      "env": {
