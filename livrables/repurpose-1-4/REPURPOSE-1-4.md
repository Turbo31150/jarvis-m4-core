...
1. **M6 LM Studio** (`<LLM_HOST>:1234`) si un modèle est **chargé** ;
...
```
$HOME/jarvis/wbs/drafts/repurpose-<slug>-<horodatage>/
...
→ Repurpose 1→4 (0-token via Ollama local (qwen2.5:7b))
  ...
  · Reel / Short…
  · Carrousel Instagram…
$HOME/jarvis/wbs/drafts/repurpose-j-ai-automatis-la-pr-paration-20260814-1930/
```
