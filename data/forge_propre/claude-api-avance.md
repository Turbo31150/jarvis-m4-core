...
**Objectif :** Concevoir des prompts qui atteignent un taux de réussite élevé sur des critères de pertinence définis (ex. exactitude factuelle, style).  
...
**Objectif :** Implémenter une logique de gestion de contexte qui maintient la cohérence sur un grand nombre de tokens d’échange sans perte d’information critique.  
...
- Tests de charge : simulation de requêtes avec k6, mesure du temps moyen de réponse et du taux d’erreur.
