...
**Objectif** : Écrire un SDK client (TypeScript ou Python) capable de créer, lire, mettre à jour et supprimer des entités MCP avec une couverture de tests unitaires.  
...
**Objectif** : Auditer une implémentation MCP et proposer trois améliorations mesurables (ex. réduction du temps de latence, renforcement du chiffrement, mise en place d’un registre de versions).  
