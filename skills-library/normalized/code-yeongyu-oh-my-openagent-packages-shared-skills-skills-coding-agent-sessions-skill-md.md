---
id: code-yeongyu-oh-my-openagent-packages-shared-skills-skills-coding-agent-sessions-skill-md
name: "coding-agent-sessions"
author: "code-yeongyu"
repository: "https://github.com/code-yeongyu/oh-my-openagent/tree/dev/packages/shared-skills/skills/coding-agent-sessions"
skill_url: "https://skillsmp.com/creators/code-yeongyu/oh-my-openagent/packages-shared-skills-skills-coding-agent-sessions"
stars: 67193
verified: false
quality_score: 100
security_score: 90
status: "SAFE"
collected_at: "2026-08-07T17:08:08.645117"
---
...
# Objectif
Skill d'automatisation/intégration pour coding-agent-sessions.

# Déclencheurs d’utilisation
Mots-clés associés: coding-agent-sessions, code-yeongyu

# Procédure
Consulter le dépôt source: https://github.com/code-yeongyu/oh-my-openagent/tree/dev/packages/shared-skills/skills/coding-agent-sessions
