...
[assistant] I have the header confirming key metadata. Let me search the indexed content for the substantive holding on temps de travail, amplitude, astreinte, and equivalence.

[assistant] The titrages section is highly informative. Let me extract the operative reasoning text directly to confirm the holding.

[assistant] The raw HTML likely renders the body via the indexed markdown. Let me query the indexed content for the fuller titrage and holding.