...
[assistant] The quote is verbatim. Now let me check whether the same thread and subsequent driver development contradict it.

[assistant] Decisive contradictions found in the same thread and the project's own README. Let me record the verdict.