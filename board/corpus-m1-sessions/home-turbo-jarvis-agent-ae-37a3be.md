...
[assistant] I'll verify this claim by checking the liquidctl documentation and supported devices list.

[assistant] I verified against liquidctl's primary sources (guide, README device table, driver source, CHANGELOG, and issue tracker).