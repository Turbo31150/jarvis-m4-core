...
[assistant] Primary source fully confirms the details. Now let me check for contradictions against Anthropic's own docs and the Claude Code implementation.

[assistant] Let me check the provenance of agentskills.io and cross-check Anthropic's own spec repo.

[assistant] All checks complete. The claim verifies verbatim against the canonical primary source, and Anthropic's own spec repo now redirects to it.