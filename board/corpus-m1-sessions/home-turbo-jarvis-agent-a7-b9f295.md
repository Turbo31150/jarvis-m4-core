...
[assistant] The numbers verify exactly. Now let me check for contradicting evidence and internal consistency.

[assistant] Verified against the primary source. Numbers are real; the causal framing is not.