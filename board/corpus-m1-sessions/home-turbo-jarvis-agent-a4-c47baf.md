...
[assistant] The search result quotes a phrase suggesting the page *does* mention RGB lighting. Let me verify against the raw page source.

[assistant] The page mentions "rgb chipsets" — and the supporting quote is about drivers, not RGB. Let me check CoolerControl's other official docs for lighting capability.

[assistant] Let me confirm the lighting-control capability is real in CoolerControl's UI, not just a marketing bullet.